...
public class ModSounds {
    public static final Identifier MOJANG_LOGO_SOUND = Identifier.of("mla", "mojang_sound");
    public static SoundEvent MOJANG_LOGO_SOUND_EVENT = SoundEvent.of(MOJANG_LOGO_SOUND);

    public static final Identifier MOJANG_APRIL_FOOL_SOUND = Identifier.of("mla", "mojang_april_fool_sound");
